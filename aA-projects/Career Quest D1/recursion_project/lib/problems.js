...
function fileFinder(directories, targetFile) {
    ...
    for(let key in directories) {
        ...
        // if(fileFinder(directories[key], targetFile) return true;
    };
    ...
    //     if (keys[i] === targetFile || fileFinder(directories[keys[i]], targetFile)) return true; 
    // }
...
function pathFinder(directories, targetFile) {
    for (let key in directories) {
        ...
        let previousPath = pathFinder(directories[key], targetFile);
        if (previousPath) {
            return key + previousPath;
        }
    };
